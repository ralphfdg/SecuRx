...
<body class="antialiased bg-slate-50 text-gray-800 min-h-screen flex overflow-hidden selection:bg-securx-cyan selection:text-white relative">
    ...
    <aside class="w-64 glass-panel m-4 flex flex-col z-20 hidden md:flex h-[calc(100vh-2rem)] border-r border-gray-200/50">
        ...
        <div class="p-6 border-b border-gray-200/50 flex items-center gap-2">
            <div class="w-8 h-8 bg-securx-cyan/10 rounded-lg border border-securx-cyan/30 flex items-center justify-center text-securx-cyan">
        ...
        <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
            ...
            <a href="{{ route('patient.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-securx-cyan/10 text-securx-navy font-bold transition">
            ...
            <a href="{{ route('patient.qr-live') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-500 hover:bg-white/60 hover:text-securx-navy font-semibold transition">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                My Prescriptions
            </a>

            <a href="{{ route('patient.qr-print') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-500 hover:bg-white/60 hover:text-securx-navy font-semibold transition">
            ...
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-500 hover:bg-white/60 hover:text-securx-navy font-semibold transition">
        ...
        <div class="p-4 border-t border-gray-200/50">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-securx-navy flex items-center justify-center text-white font-bold shadow-sm">
                    RD
                </div>
                <div>
                    <p class="text-sm font-bold text-securx-navy">Ralph D.</p>
