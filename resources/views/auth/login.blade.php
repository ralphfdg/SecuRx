...
<body class="antialiased bg-slate-50 text-gray-800 min-h-screen flex items-center justify-center relative selection:bg-securx-cyan selection:text-white overflow-hidden">
    ...
    <div class="glass-panel p-8 md:p-10 z-10 mx-4 w-full max-w-md">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div>
                <label for="login_id" class="block text-sm font-bold text-securx-navy mb-1.5">Email Address or Username</label>
            ...
            <div class="flex items-center justify-between text-sm">
                <label class="flex items-center text-gray-500 hover:text-securx-navy cursor-pointer transition-colors">
                    <input type="checkbox" name="remember" class="rounded border-gray-300 text-securx-cyan focus:ring-securx-cyan shadow-sm">
                    <span class="ml-2 font-medium">Remember me</span>
                </label>
                <a href="#" class="text-securx-cyan hover:text-securx-navy font-bold transition-colors">Forgot password?</a>
            </div>
            ...
            <div class="pt-6 mt-6 border-t border-gray-100 text-center space-y-2 text-sm text-gray-500 font-medium">
                <p>Don't have an account? <a href="{{ route('register') }}" class="text-securx-cyan hover:text-securx-navy font-bold transition-colors">Sign up</a></p>
                <p>Need assistance? <a href="{{ route('help') }}" class="hover:text-securx-navy font-semibold transition-colors">Visit Help Center</a></p>
            </div>
        </form>
    </div>
