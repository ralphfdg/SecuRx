...
<body class="antialiased bg-slate-50 text-gray-800 min-h-screen flex items-center justify-center relative selection:bg-securx-cyan selection:text-white py-12">
    ...
    <div class="absolute top-6 right-6 md:top-8 md:right-8 z-20 fixed">
        <a href="{{ route('home') }}" class="px-4 py-2 bg-white/60 border border-gray-200 rounded-md text-sm font-semibold text-gray-500 hover:text-securx-navy hover:border-securx-cyan/30 hover:bg-white backdrop-blur-sm transition-all flex items-center gap-2 shadow-sm">
            &larr; Back to Index
        </a>
    </div>
    ...
    <div class="glass-panel p-8 md:p-12 z-10 mx-4 w-full max-w-5xl relative mt-12 md:mt-0">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="space-y-5">
                    <h3 class="text-lg font-bold text-securx-navy border-b border-securx-cyan/30 pb-2 mb-4 flex items-center gap-2">
                        <svg class="w-5 h-5 text-securx-cyan" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="first_name" class="glass-input w-full py-2 px-3" required autofocus>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="date" name="dob" class="glass-input w-full py-2 px-3 text-gray-600" required>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="mobile_num" placeholder="+63 900 000 0000" class="glass-input w-full py-2 px-3" required>
                    </div>
                </div>

                <div class="space-y-5">
                    <h3 class="text-lg font-bold text-securx-navy border-b border-securx-gold/40 pb-2 mb-4 flex items-center gap-2">
                        <svg class="w-5 h-5 text-securx-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        @if($role === 'doctor') Clinical Authority @elseif($role === 'pharmacist') Facility Details @else Medical & Demographics @endif
                    </h3>
                    ...
                    @if($role === 'doctor')
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="license_number" class="glass-input w-full py-2 px-3" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-securx-navy mb-1.5">PRC Expiration *</label>
                                <input type="date" name="license_expiration" class="glass-input w-full py-2 px-3 text-gray-600" required>
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="s2_number" placeholder="(For dangerous drugs)" class="glass-input w-full py-2 px-3">
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-securx-navy mb-1.5">S2 Expiration</label>
                                <input type="date" name="s2_expiration" class="glass-input w-full py-2 px-3 text-gray-600">
                            </div>
                        </div>

                    @elseif($role === 'pharmacist')
                        <div>
                            <label class="block text-sm font-bold text-securx-navy mb-1.5">Pharmacy Branch Name *</label>
                            <input type="text" name="pharmacy_name" placeholder="e.g. Mercury Drug - Main" class="glass-input w-full py-2 px-3" required>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-bold text-securx-navy mb-1.5">FDA LTO Number *</label>
                                <input type="text" name="lto_number" class="glass-input w-full py-2 px-3" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-securx-navy mb-1.5">LTO Expiration *</label>
                                <input type="date" name="lto_expiration" class="glass-input w-full py-2 px-3 text-gray-600" required>
                            </div>
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-securx-navy mb-1.5">Supervising Pharmacist *</label>
                            <input type="text" name="pharmacist_in_charge" class="glass-input w-full py-2 px-3" required>
                        </div>
                        <div>
                            <label class="block text-sm font-bold text-securx-navy mb-1.5">Business Address *</label>
                            <input type="text" name="business_address" class="glass-input w-full py-2 px-3" required>
                        </div>
                    ...
                    @else
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="height" placeholder="e.g. 170" class="glass-input w-full py-2 px-3" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-securx-navy mb-1.5">Weight (kg) *</label>
                                <input type="number" name="weight" placeholder="e.g. 65" class="glass-input w-full py-2 px-3" required>
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="p-4 bg-white/50 border border-gray-200 rounded-lg mt-2 space-y-3">
                            <p class="text-xs font-bold text-securx-navy uppercase tracking-wider mb-2">Emergency / Guardian Info</p>
                            <div class="grid grid-cols-2 gap-3">
                                <input type="text" name="mother_name" placeholder="Mother's Name" class="glass-input w-full py-1.5 px-3 text-sm">
                                <input type="tel" name="mother_contact" placeholder="Mother's Contact" class="glass-input w-full py-1.5 px-3 text-sm">
                                <input type="text" name="father_name" placeholder="Father's Name" class="glass-input w-full py-1.5 px-3 text-sm">
                                <input type="tel" name="father_contact" placeholder="Father's Contact" class="glass-input w-full py-1.5 px-3 text-sm">
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="mt-8 pt-8 border-t border-gray-200/60">
                <h3 class="text-lg font-bold text-securx-navy mb-6 flex items-center justify-center gap-2">
                    <svg class="w-5 h-5 text-securx-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" class="glass-input w-full py-2.5 px-4" required>
                    </div>
                </div>

                @if($role === 'doctor' || $role === 'pharmacist')
                    <div class="mt-6 p-3 bg-securx-gold/10 border border-securx-gold/30 rounded-lg text-sm text-securx-gold font-semibold text-center max-w-3xl mx-auto">
                        * Note: Professional accounts require system administrator verification before prescribing or dispensing access is granted.
                    </div>
                @endif
                ...
                <div class="max-w-md mx-auto mt-8 text-center">
                    ...
                    <p class="mt-4 text-sm text-gray-500 font-medium">
                        Already registered? <a href="{{ route('login') }}" class="text-securx-cyan hover:text-securx-navy font-bold transition-colors">Sign in here</a>
                    </p>
                </div>
            </div>
